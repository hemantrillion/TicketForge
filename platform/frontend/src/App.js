...
function App() {
  ...
  return (
    <div>
      ...
      {/* ================= HOMEPAGE (ZERO OVERLAP EXACT SEARCH BAR) ================= */}
      {currentPage === 'home' && (
        <main>
          <section className="ct-hero-section">
            ...
            {/* SEARCH CONTAINER MATCHING USER SCREENSHOT EXACTLY WITH ZERO OVERLAP */}
            <div className="ct-search-container">
              ...
              <div className="ct-search-box-left">
                ...
                {/* SWAP BUTTON OVERLAPPING VERTICAL DIVIDER LINE PERFECTLY WITH ZERO TEXT OVERLAP */}
